...
describe NodesController do
  ...
  describe "show" do
    ...
    it "should respond with json" do
      ...
      response.should be_success
      JSON.parse(response.body).should == { "title"=>@node1.title, "persistent_id" => @node1.persistent_id, "url" => identity_pool_node_path(@identity, @pool, @node1), "pool"=>@pool.short_name, "identity"=>@identity.short_name, "binding"=>nil, "model_id"=>@node1.model_id, "associations"=>{}, "data"=>{} }
    end
