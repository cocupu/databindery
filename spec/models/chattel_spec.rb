...
describe Chattel do
  ...
  it "should know if it's a spreadsheet" do
    ...
    chattel = Cocupu::Spreadsheet.create(:attachment => Rack::Test::UploadedFile.new(Rails.root + 'spec/fixtures/dechen_rangdrol_archives_database.xls', 'application/vnd.ms-excel'))
