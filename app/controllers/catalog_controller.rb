class CatalogController < ApplicationController
  ...
  solr_search_params_logic << :add_exhibit_specific_fields << :add_pool_to_fq << :add_exhibit_specific_facets
  ...
  def add_exhibit_specific_fields(solr_parameters, user_params)
  ...
  def add_exhibit_specific_facets(solr_parameters, user_params)
    facets = @exhibit.facets.map{ |key| Node.solr_name(key, 'facet')}
    facets << 'model_name'
    solr_parameters['facet.field'] = facets
  end
