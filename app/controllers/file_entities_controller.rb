class FileEntitiesController < ApplicationController
  ...
  def s3_upload_info
    ...
    render :json => {
        ...
        success_action_redirect: identity_pool_file_entities_path(@identity, @pool),
  ...
  def s3_upload_signature
    signature = Base64.encode64(OpenSSL::HMAC.digest(OpenSSL::Digest::Digest.new('sha1'), AWS.config.secret_access_key, s3_upload_policy_document)).gsub("\n","")
  end
