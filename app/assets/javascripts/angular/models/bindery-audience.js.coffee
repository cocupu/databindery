angular.module('curateDeps').factory('BinderyAudience', ['$resource', ($resource) ->
  ...
  BinderyAudience = $resource("/:identityName/:poolName/audience_categories/:categoryId/audiences/:id.json", {identityName:'@identity_name', poolName:'@pool_name', categoryId:'@audience_category_id', id:'@id'}, {
    save: {
      method: 'POST',
